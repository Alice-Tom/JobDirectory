  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 mx-auto text-center mb-5 section-heading">
          <h2 class="mb-5" >Manage Jobs</h2>
        </div>

        @if(Session::has('managejobs'))
        <div class="alert alert-success" role="alert">
          {{Session::get('managejobs')}}
        </div>
        @endif
      ...
      <table  class="table table-hover" >
          ...
          @foreach ($jobs as $jobs) 
              ...
              <td>{{$jobs->deadline}}</td>
              <td>{{$jobs->job_type}}</td>
              <td> <button class="button"> <a class="buttona" href="/company/editjob/{{$jobs->id}}">Edit</button></a>
                <br>
                <br>
