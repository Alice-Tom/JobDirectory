...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="text-align: center; font-size:25px;">{{ __('Create a Job Seeker Account') }}</div>
                 <div class="card-header" style="text-align: center; font-size:20px;">{{ __('Your new career is one click away') }}</div>
               
                <div class="card-body">
                    <form method="POST" action="{{ route('register.store', ['registration_type' => 'job_seeker']) }}">
                        @csrf
