  ...
  <div class="site-wrap">
    ...
    <div class="unit-5 overlay" style="background-image: url('images/hero_1.jpg');">
      <div class="container text-center">
        <h2 class="mb-0">Connecting you with Job Seekers and Tender Seekers</h2>
      ...
      <div class="container">
        ...
        <div class="d-block d-md-flex border-bottom">
          <div class="text-center p-4 item border-right" data-aos="fade">
            ...
            <p>Post your Job and Tenders easily. Connect with other Employers and Tenderers on the way</p>
            
          </div>
          <div class="text-center p-4 item" data-aos="fade">
            <span class="flaticon-wrench display-3 mb-3 d-block text-primary"></span>
            <h2 class="h4">Creative Consultants</h2>
            <p>Find a creative and dedicated consultants. Get help on any IT stack  </p>
